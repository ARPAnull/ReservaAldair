...
public class MainActivity extends AppCompatActivity implements OnSeekBarChangeListener,
    ...
    EditText nombre, txtDireccion, txtNumero, txtCorreo;
    TextView cuantasPersonas, txtViewDireccion, txtViewNumero, txtViewCorreo;
    Button fecha, hora;
    ...
    public void reserva(View v) {
        ...
        datos.putString("direccion", (String)txtDireccion.getText().toString());
        datos.putString("numero", (String)txtNumero.getText().toString());
        datos.putString("correo", (String)txtCorreo.getText().toString());
